...
| `introduction_requests` | `/messages/introductions` | live route | live API | partially implemented | Introduction center now uses live member search, direct-message threads, direct handoffs, and live readiness signals; dedicated request approval workflow remains future backend work. |
