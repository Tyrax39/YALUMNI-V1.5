...
| `chapter_analytics_dashboard` | `/admin/chapters/[chapterId]/analytics` | live route | live API | partially implemented | Chapter analytics now derives live chapter health, operational priorities, moderation footprint, removed-content backlog, and quick-read signals from current community, roster, invitation, post, and moderation APIs. |
