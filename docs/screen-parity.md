...
| `chapter_leader_dashboard` | `/communities/[communityId]/dashboard` | live route | live API | partially implemented | Dedicated leader dashboard now uses live community, roster, invitation, post, and report APIs plus live operational priorities and leadership coverage signals. |
