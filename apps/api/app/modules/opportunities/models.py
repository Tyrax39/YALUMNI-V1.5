...
class Opportunity(Base, TimestampMixin):
    ...
    __table_args__ = (
        ...
        Index("ix_opportunities_type_country", "opportunity_type", "country"),
        Index("ix_opportunities_creator_status", "created_by_user_id", "status"),
    )
    ...
    opportunity_type: Mapped[str] = mapped_column(String(80), default="FELLOWSHIP", nullable=False)
    location: Mapped[str | None] = mapped_column(String(160))
    country: Mapped[str | None] = mapped_column(String(80))
    remote_policy: Mapped[str] = mapped_column(String(40), default="HYBRID", nullable=False)
