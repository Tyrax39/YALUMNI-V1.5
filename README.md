...
- Current-user alumni profile, program affiliation, visibility JSON settings, dashboard profile completion panel, verification request submission, local evidence uploads, admin review queue, and verified alumni directory search
